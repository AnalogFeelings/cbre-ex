...
namespace CBRE.BspEditor.Tools.Brush.Brushes
{
    ...
    public class WedgeBrush : IBrush
    {
        ...
        public IEnumerable<IMapObject> Create(UniqueNumberGenerator generator, Box box, string texture, int roundDecimals)
        {
            ...
            Vector3 c5 = new Vector3(box.Center.X, box.Start.Y, box.End.Z).Round(roundDecimals);
            Vector3 c6 = new Vector3(box.Center.X, box.End.Y, box.End.Z).Round(roundDecimals);
            Vector3[][] faces = new[]
                            {
                                new[] { c1, c2, c3, c4 },
                                new[] { c2, c1, c5 },
