...
namespace CBRE.Shell.Settings.Editors
{
    public partial class ColorEditor : UserControl, ISettingEditor
    {
        ...
        public object Value
        {
            ...
            set
            {
                object v = value ?? Color.Black;
                ColorPanel.BackColor = (Color) v;
                Color c = ColorPanel.BackColor;
        ...
        {
            using (ColorDialog cp = new ColorDialog {Color = ColorPanel.BackColor, SolidColorOnly = true})
            {
        ...
        private void UpdateHex(object sender, EventArgs e)
        {
            ...
            {
                Color color = ColorTranslator.FromHtml('#' + HexBox.Text);
